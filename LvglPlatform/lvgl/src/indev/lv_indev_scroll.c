                            ...
                            lv_dir_t dir)
{
    ...
    if ((!lv_obj_has_flag(scroll_obj, LV_OBJ_FLAG_SCROLL_ELASTIC) &&
        !lv_obj_has_flag(scroll_obj, ZH_LV_OBJ_FLAG_SCROLL_ELASTIC_HOR) &&
        !lv_obj_has_flag(scroll_obj, ZH_LV_OBJ_FLAG_SCROLL_ELASTIC_VER)) ||
        (lv_obj_has_flag(scroll_obj, ZH_LV_OBJ_FLAG_SCROLL_ELASTIC_HOR) && dir == LV_DIR_VER) ||
        (lv_obj_has_flag(scroll_obj, ZH_LV_OBJ_FLAG_SCROLL_ELASTIC_VER) && dir == LV_DIR_HOR))//add by wangjinsong
    {
