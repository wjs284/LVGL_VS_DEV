...
typedef enum {
    ...
    ZH_LV_OBJ_FLAG_SCROLL_ELASTIC_HOR = (1L << 27), /**< Custom flag, free to use by user*///add by wjs
    ZH_LV_OBJ_FLAG_SCROLL_ELASTIC_VER = (1L << 28), /**< Custom flag, free to use by user*///add by wjs
